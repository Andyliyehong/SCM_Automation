...
def main():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            # Step 7: Navigate to Xylem Reports Section
            print("7. Navigating to Xylem Reports tab and Scenario Comparison - Analytics...")
            time.sleep(3)
            click_menu_item(page, "Xylem Reports")
            time.sleep(1)
            ...
            # Step 8: Retrieve ScenarioComparison_Analytics as table
            # table_html = page.locator("#TopGrid table").inner_html()
            ...
            # df = pd.DataFrame(data2, columns=headers2)
            # print(df.head(10))
